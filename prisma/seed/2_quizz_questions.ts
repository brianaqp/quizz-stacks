...
async function main() {
  ...
  await prisma.option.createMany({
    data: [
      ...
      { question_id: 1, content: "I quietly observe.", category: "vue" },
      {
        question_id: 1,
      ...
      // Question 2 options
      { question_id: 2, content: "Energetic pop or EDM.", category: "react" },
      { question_id: 2, content: "Calm and relaxing jazz.", category: "vue" },
      {
        question_id: 2,
        content: "Classic rock or alternative.",
        category: "angular",
      },
      { question_id: 2, content: "Experimental indie.", category: "svelte" },
      ...
      {
        question_id: 3,
        content: "I try different things and see what works.",
        category: "react",
      },
      {
        question_id: 3,
      ...
      { question_id: 4, content: "I like supporting others.", category: "vue" },
      { question_id: 4, content: "I take the lead.", category: "angular" },
      {
        question_id: 4,
      ...
      {
        question_id: 5,
        content: "I learn new skills or work on personal projects.",
        category: "angular",
      },
      {
        question_id: 5,
      ...
      { question_id: 8, content: "A relaxing beach resort.", category: "vue" },
      {
        question_id: 8,
      ...
      { question_id: 9, content: "Feel-good comedies.", category: "react" },
      { question_id: 9, content: "Heartwarming dramas.", category: "vue" },
      ...
      { question_id: 10, content: "I trust my intuition.", category: "svelte" },

      // Question 11 options
      { question_id: 11, content: "I hit the dance floor!", category: "react" },
      {
        question_id: 11,
      ...
      {
        question_id: 12,
        content: "I enjoy learning through videos and tutorials.",
        category: "vue",
      },
      {
        question_id: 12,
